    ...
    <>
      ...
      <div id="certificate" className="max-w-3xl mx-auto">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border-8 border-double border-blue-800">
          {/* Header band */}
          <div className="bg-gradient-to-r from-blue-800 to-indigo-900 px-10 py-6 text-center">
          ...
          <div className="px-12 py-10 text-center">
            ...
            <div className="flex justify-around items-end gap-8">
              ...
              <div className="flex-shrink-0 w-16 h-16 rounded-full bg-gradient-to-br from-blue-800 to-indigo-900 flex items-center justify-center shadow-lg">
          ...
          {/* Footer band */}
          <div className="bg-gradient-to-r from-blue-800 to-indigo-900 px-10 py-3 text-center">
